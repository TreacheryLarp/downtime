...
urlpatterns = patterns('',
    ...
    url(r'^s/(?P<session>\d+)/f$', staff_member_required(views.ActionListView.as_view()), name='feedings'),
    url(r'^s/(?P<session>\d+)/d$', staff_member_required(views.ActionListView.as_view()), name='disciplines'),
    url(r'^s/(?P<session>\d+)/c$', staff_member_required(views.ActionListView.as_view()), name='characters'),
